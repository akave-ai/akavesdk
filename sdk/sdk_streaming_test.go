...
func TestStreamingCreateBucket(t *testing.T) {
...
func TestStreamingViewBucket(t *testing.T) {
	akave, err := sdk.New(PickNodeRPCAddress(t), maxConcurrency, blockPartSize.ToInt64(), true)
	require.NoError(t, err)
	t.Cleanup(func() {
		require.NoError(t, akave.Close())
...
func TestStreamingListBuckets(t *testing.T) {
	akave, err := sdk.New(PickNodeRPCAddress(t), maxConcurrency, blockPartSize.ToInt64(), true)
	require.NoError(t, err)
	t.Cleanup(func() {
		require.NoError(t, akave.Close())
...
func TestStreamingDeleteBucket(t *testing.T) {
...
func TestStreamingDeleteFile(t *testing.T) {
	ctx := context.Background()
...
func TestStreamingUploadDownloadSmallFiles(t *testing.T) {
	tests := []struct {
		name     string
...
func TestStreamingUploadRandomDownloadSmallFiles(t *testing.T) {
	tests := []struct {
		name     string
		fileSize int64 // Size in bytes
	}{
...
func TestStreamingUploadRandomDownload(t *testing.T) {
	tests := []struct {
		name     string
		fileSize int64
	}{
...
func TestStreamingUploadDownloadSameBlocks(t *testing.T) {
	akave, err := sdk.New(PickNodeRPCAddress(t), maxConcurrency, blockPartSize.ToInt64(), true)
	require.NoError(t, err)
	t.Cleanup(func() {
		require.NoError(t, akave.Close())
...
// Greater than block size.
func TestStreamingUploadDownloadWithEncryption(t *testing.T) {
	tests := []struct {
		name     string
		fileSize int64 // Size in MB
	}{
...
func TestStreamingDownloadECFileWithoutErasureCodingSDK(t *testing.T) {
	ctx := context.Background()
...
func TestStreamingListFiles(t *testing.T) {
	ctx := context.Background()
...
func TestStreamingFileVersions(t *testing.T) {
	ctx := context.Background()
...
func TestStreamingFileInfo(t *testing.T) {
	ctx := context.Background()
	bucketName := randomBucketName(t, 10)
